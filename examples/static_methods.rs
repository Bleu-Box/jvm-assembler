...
fn main() {
...

    {
        ...
        method.load_constant("Beloved");
        method.load_constant("Rust");
        method.invoke_static("static_methods", "hello_someone",
                             &[Java::Class("java/lang/String"),
                               Java::Class("java/lang/String")],
                             &Java::Void);
        method.do_return();
    ...
    {
        let mut method = class.define_method(ACC_STATIC, "hello_someone",
                                             &[Java::Class("java/lang/String"),
                                               Java::Class("java/lang/String")],
                                             &Java::Void);
        method.get_static("java/lang/System", "out", &Java::Class("java/io/PrintStream"));
        method.load_constant("Hello, ");
        method.invoke_virtual("java/io/PrintStream", "print",
        ...
        method.invoke_virtual("java/io/PrintStream", "println",
                              &[Java::Class("java/lang/String")], &Java::Void);
